const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://dev-api.fuzeapp.services';
const PROFILE_BASE_URL = import.meta.env.VITE_PROFILE_BASE_URL || 'https://dev-web.fuzeapp.services';
